...
export const metadata: Metadata = {
  title: "International Digital Marketing Campaigns India | Global Google & Meta Ads | Proshala",
  description:
  ...
  alternates: { canonical: "https://proshala.com/services/international-campaigns" },
  openGraph: {
    title: "International Digital Marketing Campaigns | Proshala",
    description:
    ...
    url: "https://proshala.com/services/international-campaigns",
    siteName: "Proshala",
    images: [{ url: "https://proshala.com/og-image.jpg", width: 1200, height: 630 }],
  },
};
...
const markets = [
  ...
  { flag: "🇬🇧", country: "United Kingdom",  currency: "GBP", note: "Strong e-commerce & B2B SaaS market with high LTV." },
  { flag: "🇦🇪", country: "UAE & Gulf",       currency: "AED", note: "High-value consumers, low competition keywords." },
  { flag: "🇦🇺", country: "Australia",        currency: "AUD", note: "English-speaking, high purchase intent audience." },
  { flag: "🇨🇦", country: "Canada",           currency: "CAD", note: "Bilingual targeting — English & French markets." },
  { flag: "🇸🇬", country: "Singapore & SEA", currency: "SGD", note: "Fast-growing digital ad market with rising spend." },
  { flag: "🇩🇪", country: "Germany & EU",    currency: "EUR", note: "Multilingual campaigns across key EU markets." },
...
const services = [
  {
    ...
    tag: "Most Popular",
    desc: "Search, Display, Shopping, and YouTube campaigns targeting international markets — with geo-specific bidding, currency, and audience strategy built for each country.",
    points: [
  ...
  },
  {
    ...
    desc: "Market-specific landing pages with local currency, local trust signals, local phone numbers, and culturally relevant copy that converts.",
    points: [
  ...
  },
  {
    ...
    tag: "Full Visibility",
    desc: "Unified dashboard showing performance by country, currency, and channel — all in one view with INR / local currency toggle.",
    points: [
...
const advantages = [
  ...
  },
  {
    ...
    desc: "We have managed campaigns across USA, UK, UAE, Australia, Canada, and Southeast Asia — we know what works in each market.",
  },
  {
    icon: Shield,
    title: "Compliance Aware",
    desc: "GDPR for EU, CCPA for California, ASA guidelines for UK — we ensure every campaign meets local advertising regulations.",
  },
];
...
const process = [
  {
    ...
    desc: "Deep dive into your target markets — search volume, CPC benchmarks, competitor landscape, and audience behaviour in each country.",
  },
  {
    step: "02",
    title: "Campaign Architecture",
    desc: "Country-separated campaign structure, currency setup, geo-bidding strategy, and market-specific landing page plan.",
  },
  {
    step: "03",
    title: "Launch & Localise",
    desc: "Campaigns go live with market-specific ad copy, extensions, and landing pages. First two weeks: intensive daily optimisation.",
  },
  {
    step: "04",
    title: "Scale & Report",
    desc: "Monthly cross-market performance reports. We scale budgets into top-performing markets and pull back from underperformers.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    a: "For English-speaking markets (USA, UK, Australia, Canada), we write native-quality copy in-house. For Arabic (UAE), German, French, and other languages, we use native-speaker copywriters to ensure cultural accuracy — not just Google Translate.",
  },
  {
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "International Campaigns",     item: "https://proshala.com/services/international-campaigns" },
  ],
};
        ...
        <section className="relative pt-28 pb-16 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
            ...
            <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-white/30 mb-8 flex-wrap">
              ...
              <ChevronRight className="w-3 h-3" />
              <span className="text-white/55">International Campaigns</span>
            </nav>
            ...
            <div className="max-w-3xl">
              ...
              <h1 className="text-[38px] sm:text-5xl lg:text-[58px] font-black leading-[1.05] tracking-tight mb-5">
                <span className="text-white">Reach Global Markets</span>
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500">
                  From India —
                </span>
                <br />
                <span className="text-white">At Indian Agency Rates</span>
              </h1>

              <p className="text-white/55 text-base sm:text-lg leading-relaxed mb-4 max-w-xl">
                Why pay $5,000/month to a US agency when you can get the same
                Google-certified expertise for a fraction of the cost? Proshala manages
                high-performing{" "}
                <strong className="text-white">Google Ads, Meta Ads, and SEO</strong>{" "}
                campaigns targeting USA, UK, UAE, Australia, and beyond — from our base
                in Delhi NCR.
              </p>
              <p className="text-white/35 text-sm leading-relaxed mb-8 max-w-xl">
                Same platforms. Same certifications. Same results.{" "}
                <strong className="text-amber-400">60% less cost</strong>.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <span className="text-amber-500 font-semibold text-xs uppercase tracking-[0.16em]">Markets We Cover</span>
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full" />
              </div>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-amber-500 font-bold">{currency}</div>
                    </div>
                  </div>
        ...
        <section className="py-16 bg-[#0D0D0D] border-y border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 mb-4">
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full" />
                <span className="text-amber-500 font-semibold text-xs uppercase tracking-[0.16em]">What We Offer</span>
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full" />
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-3">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {services.map(({ icon: Icon, title, tag, desc, points }, i) => (
                <div
                  key={i}
                  className="bg-white/[0.025] border border-white/[0.07] rounded-2xl p-6 hover:border-amber-500/35 hover:-translate-y-1.5 hover:shadow-xl hover:shadow-amber-500/5 transition-all duration-300 group flex flex-col"
                  style={{ animation: `fadeSlideUp 0.6s ease ${i * 0.07}s both` }}
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-10 h-10 bg-amber-500/10 border border-amber-500/15 rounded-xl flex items-center justify-center group-hover:bg-amber-500/20 group-hover:scale-110 transition-all">
                      <Icon className="w-4.5 h-4.5 text-amber-400" />
                    </div>
                    <span className="inline-flex items-center bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] font-bold px-2.5 py-0.5 rounded-full">
                      {tag}
                    </span>
                  </div>
        ...
        <section className="py-16 lg:py-20 bg-[#0A0A0A]">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 mb-4">
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full" />
                <span className="text-amber-500 font-semibold text-xs uppercase tracking-[0.16em]">The India Advantage</span>
                <span className="w-1.5 h-1.5 bg-amber-500 rounded-full" />
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-3">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
              {advantages.map(({ icon: Icon, title, desc }, i) => (
                <div
                  key={i}
                  className="bg-white/[0.025] border border-white/[0.07] rounded-2xl p-6 hover:border-amber-500/35 hover:-translate-y-1 transition-all group text-center"
                  style={{ animation: `fadeSlideUp 0.5s ease ${i * 0.07}s both` }}
                >
                  <div className="w-10 h-10 bg-amber-500/10 border border-amber-500/15 rounded-2xl flex items-center justify-center mb-4 mx-auto group-hover:bg-amber-500/20 group-hover:scale-110 transition-all">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-white/[0.025] border border-white/[0.07] rounded-2xl overflow-hidden">
                <div className="grid grid-cols-3 bg-white/[0.04] border-b border-white/[0.07]">
                  <div className="px-4 py-3 text-xs font-bold text-white/40">Agency Type</div>
                  <div className="px-4 py-3 text-xs font-bold text-white/60 text-center">Monthly Mgmt Fee</div>
                  <div className="px-4 py-3 text-xs font-bold text-amber-400 text-center">With Proshala</div>
                </div>
                {[
                  ...
                  >
                    <div className="px-4 py-3 text-xs font-medium text-white/70">{type}</div>
                    <div className="px-4 py-3 text-xs text-white/40 text-center">{cost}</div>
                    <div className="px-4 py-3 text-xs text-amber-400 font-bold text-center">{saving}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {process.map(({ step, title, desc }, i) => (
                ...
                >
                  <div className="text-5xl font-black text-amber-500/15 group-hover:text-amber-500/25 transition-colors mb-3 leading-none">
                    {step}
                  </div>
                  <h3 className="font-bold text-white text-sm mb-2 group-hover:text-amber-400 transition-colors">
                    {title}
                  ...
                  {i < process.length - 1 && (
                    <div className="hidden lg:block absolute top-8 left-full w-full h-px z-10">
                      <div className="h-full bg-gradient-to-r from-amber-500/25 to-transparent" />
                    </div>
                  )}
                </div>
              ))}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-white/50 text-sm leading-relaxed mb-6">
                  We are not just a local agency that also does international.
                  International campaigns are one of our core specialisations — we
                  understand cross-border targeting, currency bidding, compliance
                  differences, and cultural nuances that generic agencies consistently miss.
                </p>
                <div className="space-y-3">
                  {[
                    "Google-certified team managing 12+ country campaigns",
                    "Country-separated campaign structure — no budget mixing",
                    "Native-quality ad copy for all English-speaking markets",
                    "GDPR, CCPA, ASA compliance built into every campaign",
                    "Multi-currency Looker Studio reporting dashboard",
                    "Timezone coverage across UAE, UK, and US business hours",
                  ].map((item, i) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    ...
                    style={{ animation: `fadeSlideUp 0.5s ease ${i * 0.07}s both` }}
                  >
                    <div className="w-8 h-8 bg-amber-500/10 border border-amber-500/15 rounded-xl flex items-center justify-center mb-2 group-hover:bg-amber-500/20 group-hover:scale-110 transition-all">
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden bg-[#0A0A0A]">
          ...
          >
            ...
            <p className="text-white/50 text-sm sm:text-base mb-8 max-w-md mx-auto leading-relaxed">
              Free consultation — tell us which markets you want to target and we will
              send you a market analysis, campaign strategy, and pricing within 24 hours.
            </p>
            ...
            <p className="text-white/25 text-xs">
              Free consultation · No commitment · Market analysis within 24 hours
            </p>
          </div>
        </section>
