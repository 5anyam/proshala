...
export const Testimonials = () => {
    return (
    <div className="w-full border-t border-b border-gray-200 px-5 py-16 md:py-24 text-gray-900 dark:text-white">
        <div className="w-full max-w-6xl mx-auto">
            <div className="text-center max-w-xl mx-auto">
                <h1 className="text-6xl md:text-7xl font-bold mb-5 text-gray-900 dark:text-white">What people <br/>are saying.</h1>
                ...
                <div className="text-center mb-10">
                    ...
                    <span className="inline-block w-40 h-1 rounded-full bg-yellow-500"></span>
                    <span className="inline-block w-3 h-1 rounded-full bg-yellow-500 ml-1"></span>
                    <span className="inline-block w-1 h-1 rounded-full bg-yellow-500 ml-1"></span>
                </div>
            </div>
            <div className="-mx-3 md:flex items-start">
                <div className="px-3 md:w-1/3">
                    <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800 font-light mb-6 dark:bg-gray-900">
                        <div className="w-full flex mb-4 items-center">
                            <div className="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
                                <img src="https://i.pravatar.cc/100?img=1" alt=""/>
                            </div>
                            <div className="flex-grow pl-3">
                                <h6 className="font-bold text-sm uppercase text-gray-600 dark:text-white">Saurish Sachdeva</h6>
                            </div>
                        </div>
                        <div className="w-full">
                            <p className="text-sm leading-tight "><span className="text-lg leading-none italic font-bold text-gray-400 mr-1">"</span>As a small business owner, I was skeptical about digital marketing. Proshala changed my mind completely. Their local SEO efforts have put us on the map, literally! We've seen a 300% increase in website visits and a steady stream of new customers.<span className="text-lg leading-none italic font-bold text-gray-400 ml-1">"</span></p>
                        </div>
                    </div>
